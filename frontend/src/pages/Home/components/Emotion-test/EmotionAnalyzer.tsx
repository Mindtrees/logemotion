...
const EmotionAnalyzer = () => {
  ...
  const getEmotionAdvice = (emotions: any[]) => {
    ...
    const adviceMap: { [key: string]: string } = {
      ...
      Anger:
        "It seems you're feeling frustrated. Take a deep breath and try to approach the situation calmly.",
      Fear: "I sense some anxiety in your words. Consider talking to someone you trust about your concerns.",
      Sadness:
        "Your heart seems heavy right now. Remember that it's natural to feel sad, and it's okay to seek comfort.",
      Analytical:
        "You're approaching things logically and systematically. This thoughtful approach will serve you well.",
      Confident:
        "Your confidence is shining through! This positive mindset will help you achieve your goals.",
      Tentative:
        "You seem a bit uncertain. Take your time to think things through - there's no rush to decide.",
    };

    return (
      adviceMap[topEmotion.name] ||
      "Thank you for sharing your thoughts. Take care of yourself today."
    );
  };
      ...
      <Stack spacing={4}>
        <Box sx={{ textAlign: "center" }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Analyze your emotions through text and receive personalized
            insights.
          </Typography>
        </Box>
...
Example: Today was really challenging. The project deadline is approaching and I had to work late. Unexpected problems kept coming up, but I felt accomplished working with my team to solve each issue."
            ...
            <Stack direction="row" spacing={2} justifyContent="flex-end">
              ...
              <Button
                ...
                startIcon={
                  isLoading ? <CircularProgress size={20} /> : <Analytics />
                }
              >
