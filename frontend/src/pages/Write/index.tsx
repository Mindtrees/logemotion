...
const Write: React.FC = () => {
  ...
  const todaysTip = "Joy and hope emotions are showing high levels! How about writing a gratitude journal to maintain this positive energy?";

  const transformEmotionData = (apiResponse: EmotionAnalysisResponse): EmotionAnalysisResult[] => {
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Grid container spacing={4} sx={{ alignItems: 'stretch' }}>
        ...
        <Grid item xs={12} lg={4} sx={{ display: 'flex', flexDirection: 'column' }}>
          <Box sx={{ position: 'sticky', top: 24, height: 'fit-content', display: 'flex', flexDirection: 'column', flex: 1 }}>
